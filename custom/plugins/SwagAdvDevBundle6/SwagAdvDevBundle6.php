...
namespace SwagAdvDevBundle6;

use Doctrine\ORM\Tools\SchemaTool;
use Shopware\Components\Plugin;

class SwagAdvDevBundle6 extends Plugin
{
    /**
     * {@inheritdoc}
     */
    public static function getSubscribedEvents()
    {
        return [
            ...
            //todo detail extension (bundle widget)
            //  todo add bundle slider to detail page
            //    add additional data to the product attribute in the ListProductServiceDecorator
            //  todo add bundle from specific slider to cart (Widgets/SwagBundle controller)
        ];
    }
